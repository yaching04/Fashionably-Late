            ...
            <form action="{{ route('contacts.confirm') }}" method="POST" class="contact-form" novalidate>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="email" name="email" value="{{ old('email') }}"
                        placeholder="example@example.com" class="{{ $errors->has('email') ? 'is-invalid' : '' }}">
                    @error('email')
                        <div class="field-error">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="tel-group">
                        <input type="text" name="tel1" value="{{ old('tel1') }}" placeholder="090"
                            class="{{ $errors->has('tel1') ? 'is-invalid' : '' }}">
                        <span class="tel-separator">-</span>
                        <input type="text" name="tel2" value="{{ old('tel2') }}" placeholder="1234"
                            class="{{ $errors->has('tel2') ? 'is-invalid' : '' }}">
                        <span class="tel-separator">-</span>
                        <input type="text" name="tel3" value="{{ old('tel3') }}" placeholder="5678"
                            class="{{ $errors->has('tel3') ? 'is-invalid' : '' }}">
                    </div>
                    @if ($errors->has('tel1'))
                        <div class="field-error">{{ $errors->first('tel1') }}</div>
                    @elseif($errors->has('tel2'))
                        <div class="field-error">{{ $errors->first('tel2') }}</div>
                    @elseif($errors->has('tel3'))
                        <div class="field-error">{{ $errors->first('tel3') }}</div>
                    @endif
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="address" name="address" value="{{ old('address') }}" placeholder="市区町村まで"
                ...
                <div class="form-group">
                    ...
                    <textarea id="detail" name="detail" rows="8" placeholder="お問い合わせ内容をご記入ください"
                        class="{{ $errors->has('detail') ? 'is-invalid' : '' }}">{{ old('detail') }}</textarea>
                    @error('detail')
                        <div class="field-error">{{ $message }}</div>
                    @enderror
                </div>
